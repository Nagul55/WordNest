...
function parseHSL(glowColor: string) {
...
const BorderGlow: React.FC<BorderGlowProps> = ({
  ...
  const handlePointerMove = useCallback((e: React.MouseEvent<HTMLDivElement> | React.PointerEvent<HTMLDivElement>) => {
  ...
  return (
    ...
    >
      ...
      <div className="border-glow-inner rounded-[inherit] overflow-hidden">
        {children}
      </div>
    </div>
  );
