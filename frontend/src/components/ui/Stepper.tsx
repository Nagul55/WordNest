...
export default function Stepper({
  ...
  return (
    <div className="outer-container" {...rest}>
      <div className={`step-circle-container ${stepCircleContainerClassName}`} style={{ border: '1px solid #1f1f23' }}>
...
function StepIndicator({ step, currentStep, onClickStep, disableStepIndicators }: {
  ...
  return (
    <motion.div 
      ...
      style={disableStepIndicators ? { pointerEvents: 'none', cursor: 'default' } : {}} 
      animate={status} 
      initial={false}
    >
      <motion.div
        variants={{
          ...
          complete: { scale: 1, backgroundColor: '#5227FF', color: '#5227FF' }
        }}
